...
// LOCAL DEV: Using mocks instead of real @vectord packages
// TODO: Change back to '@vectord/modal' and '@vectord/ui' for production
import Modal from '../../mocks/@vectord/modal';
import SlideFlow from './views/SlideFlow';
import { cx } from '../../mocks/@vectord/ui';
